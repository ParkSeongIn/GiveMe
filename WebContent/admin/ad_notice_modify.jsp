...
<c:import url="/nav/sidebar3.jsp"/>
	<div class="container" style="margin-top:80px">
		<div class="panel panel-default">
			...
			<form id="ModifyForm" action="${ContextPath }/controller/AllBoardIfModifyActionServlet.do" method="post">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="abcontent">내용작성</label>
					<div class="col-sm-6">
				...
				<div>
					...
					<div class="row" style="margin-top:10px">
						...
						<div class="col-sm-3">
			        		...
			        		<a class="btn btn-default" href="<%=request.getContextPath()%>/controller/AllBoardIfContentServlet.do?abidx=${abidx}">글목록</a>
						</div>
					</div>
				</div>
			</form>
