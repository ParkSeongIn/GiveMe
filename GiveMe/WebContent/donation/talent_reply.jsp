		...
		<div class="panel panel-default">
			...
			<form id="addForm" action="${ContextPath }/controller/TalentBoardReplyActionServlet.do" method="post">
				<div class="form-horizontal">
					<%-- 이 양식과 똑같이 하나하나 추가 --%>
					<div class="col-sm-10">
					<label class="radio-inline"><input type="radio" name="S">작성자</label>
					<label class="radio-inline"><input type="radio" name="H">신청자</label>
					</div>
					<div class="col-sm-10">
					...
					<div class="form-group" >
						<label class="control-label col-sm-4" for="tbpeople">신청자</label>
						<div class="col-sm-4">
							<input type="text" id="tbpeople" name="tbpeople" class="form-control"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="tbhdate">희망날짜</label>
						<div class="col-sm-4">
							<input type="text" id="tbhdate" name="tbhdate" class="form-control"/>
						</div>
					</div>
					<div class="form-group">
