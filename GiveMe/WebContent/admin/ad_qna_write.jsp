...
<div style="width:800px;margin:0 auto;margin-top:100px;">
	<h1>1:1문의 답변 Write</h1>
	 <form id="addForm" action="<%=request.getContextPath()%>/controller/admin/AdQuestionWriteActionServlet.do" method="post">
		...
		<div class="form-group">
	     ...
	     <div class="form-group">
	           ...
	           <textarea class="form-control" name="qrecontent" id="qrecontent" rows="5" cols="50" autocomplete="off"></textarea>
	   	 </div>
	     <div>
