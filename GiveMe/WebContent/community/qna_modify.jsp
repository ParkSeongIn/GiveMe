...
<div class="container">
    ...
    <form id="ModifyForm" action="<%=request.getContextPath()%>/controller/question/QuestionModifyActionServlet.do" method="post">
      	<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div>
        	...
        	<a class="btn btn-default" href="<%=request.getContextPath()%>/controller/question/QuestionContentServlet.do?qidx=<%=qv.getQidx() %>&midx=<%=qv.getMidx() %>">취소</a>
        </div>
</body>
</html>