...
/**
 * Servlet implementation class TalentBoardModifyServlet
 */
@WebServlet("/TalentBoardModifyServlet")
public class TalentBoardModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TalentBoardModifyServlet() {
        super();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TalentBoardVo tv = tbsi.TalentBoardmodifySe(tbidx);
