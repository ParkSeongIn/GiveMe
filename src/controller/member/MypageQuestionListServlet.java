...
/**
 * Servlet implementation class MypageQuestionListServlet
 */
@WebServlet("/MypageQuestionListServlet")
public class MypageQuestionListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageQuestionListServlet() {
        super();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<QuestionVo> qlist = qd.getQuestionList(midx,page_num);
